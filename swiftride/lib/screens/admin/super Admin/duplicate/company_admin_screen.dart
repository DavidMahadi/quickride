...
class _CAState extends State<CompanyAdminScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _overviewTab(bool isDark, Color bg, Color card, Color border, Color textPri, Color textSec, Color brand) {
    return SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(
      ...
      // KPIs
      Row(children: [
        _KPICard('\$${_revenue.toInt()}', 'Revenue',      Icons.attach_money_rounded,   AppColors.gold,          card, border, textPri, textSec),
        const SizedBox(width: 10),
        ...
        child: Row(children: [
          Column(children: [
            ...
            Row(children: List.generate(5, (i) => Icon(Icons.star_rounded,
              color: i < avg.round() ? AppColors.gold : border, size: 16))),
            const SizedBox(height: 4),
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              _DrawerStat(label: 'Rating',   value: '${widget.company.rating}★'),
            ]),
          ])),
    ...
    showModalBottomSheet(context: ctx, backgroundColor: card, isScrollControlled: true,
      ...
      builder: (_) => Padding(
        ...
        child: Padding(padding: const EdgeInsets.fromLTRB(20, 16, 20, 0), child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 16),
          _CAField('Role', a.role, roleC, textPri, textSec),
          const SizedBox(height: 16),
          SizedBox(width: double.infinity, child: ElevatedButton(
            onPressed: () {
              setState(() => _agents[idx] = _Agent(a.name, a.email, a.phone, roleC.text, a.active));
              Navigator.pop(ctx); _notify('${a.name} role updated');
            },
  ...
  void _showNotifSheet(BuildContext ctx, Color card, Color border, Color textPri, Color textSec) {
    final notifs = <Map<String, dynamic>>[
      ...
      {'msg': 'Review received: 5 stars',        'time': '1 hr ago',  'color': AppColors.gold},
  ...
  void _showAnalytics(BuildContext ctx, Color card, Color border, Color textPri, Color textSec, Color brand) {
    ...
    final utilPct   = _fleet.isEmpty ? 0 : ((_fleet.length - _avail) / _fleet.length * 100).toInt();
    final rows = <Map<String, dynamic>>[
      {'label': 'Total Revenue',     'value': '\$${_revenue.toInt()}',  'color': AppColors.gold},
      ...
      {'label': 'Fleet Utilisation', 'value': '$utilPct%',              'color': brand},
      {'label': 'Avg Rating',        'value': '${widget.company.rating}\u2605','color': AppColors.gold},
    ];
    showModalBottomSheet(context: ctx, backgroundColor: card, isScrollControlled: true,
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(24))),
      builder: (_) => Padding(padding: const EdgeInsets.all(20), child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        ...rows.map((r) {
          ...
          return Padding(padding: const EdgeInsets.only(bottom: 10), child: Row(children: [
            Container(width: 36, height: 36, decoration: BoxDecoration(color: clr.withOpacity(0.1), borderRadius: BorderRadius.circular(9)),
              child: Center(child: Icon(Icons.bar_chart_rounded, color: clr, size: 18))),
            const SizedBox(width: 12),
            Expanded(child: Text(r['label'] as String, style: TextStyle(fontSize: 13, color: textSec))),
            Text(r['value'] as String, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: clr)),
          ]));
        }),
      ])));
  }
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (_reply != null)
        Container(padding: const EdgeInsets.all(10),
          ...
          child: Row(children: [
            const Icon(Icons.reply_rounded, color: AppColors.gold, size: 15), const SizedBox(width: 8),
  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        _FSection('Vehicle Identity', AppColors.gold),
        _FCard(c, brd, [
        ...
        const SizedBox(height: 16),
        _FSection('Company', AppColors.gold),
        _FCard(c, brd, [
        ...
        const SizedBox(height: 16),
        _FSection('Category', AppColors.gold),
        ...
        const SizedBox(height: 16),
        _FSection('Specifications', AppColors.gold),
        _FCard(c, brd, [
            ...
            background: Container(
              ...
              child: Stack(children: [
                ...
                Positioned(bottom: 16, right: 20, child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  Text('\$${car.price.toInt()}', style: const TextStyle(color: AppColors.gold, fontSize: 28, fontWeight: FontWeight.w800)),
        ...
        SliverToBoxAdapter(child: Padding(padding: const EdgeInsets.all(16), child: Column(
          ...
          Container(padding: const EdgeInsets.all(14),
            ...
            child: Column(children: [
              ...
              _DocRow(Icons.build_outlined,         'Last Service',   '2,000 km ago',      AppColors.gold,         textPri, textSec),
              _DocRow(Icons.directions_car_outlined,'Next Service',   'Due at 3,000 km',   AppColors.gold,         textPri, textSec),
            ])),
          const SizedBox(height: 24),
          Row(children: [
  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        const SizedBox(height: 20),
        _FSection('Personal Information', AppColors.gold),
        _FCard(c, brd, [
        ...
        const SizedBox(height: 16),
        _FSection('Gender', AppColors.gold),
        ...
        const SizedBox(height: 16),
        _FSection('Company & Role', AppColors.gold),
        _FCard(c, brd, [
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), child: Row(children: [
            Icon(Icons.business_outlined, color: widget.textSec, size: 18), const SizedBox(width: 12),
        ...
        const SizedBox(height: 16),
        _FSection('Account Credentials', AppColors.gold),
        _FCard(c, brd, [
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), child: Column(
            ...
            const SizedBox(height: 8),
            Row(children: [
              const Icon(Icons.info_outline_rounded, size: 13, color: AppColors.gold), const SizedBox(width: 6),
...
class _SpecTile extends StatelessWidget {
  ...
  @override Widget build(BuildContext c) => Container(
    ...
    child: Row(children: [
      Icon(icon, color: AppColors.gold, size: 16), const SizedBox(width: 8),
        ...
        _CSettCard(widget.card, widget.border, [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), child: Row(children: [
            Container(width: 36, height: 36,
              ...
              child: const Icon(Icons.attach_money_rounded, color: AppColors.gold, size: 18)),
            const SizedBox(width: 12),
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
