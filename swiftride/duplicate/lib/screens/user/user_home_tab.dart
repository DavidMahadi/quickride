    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Hello, ${AuthService.userName.split(' ').first} 👋',
        ...
        actions: [
          ...
          Stack(children: [
            IconButton(icon: Icon(Icons.notifications_outlined, color: textPri, size: 22), onPressed: () => Navigator.pushNamed(context, '/user/settings')),
