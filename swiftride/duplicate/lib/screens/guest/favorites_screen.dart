...
class _FavoritesScreenState extends State<FavoritesScreen> {
  final List<_FavCar> _favs = [
    _FavCar(name: 'Toyota RAV4', company: 'DriveKigali', price: '\$60/day', seats: 5, fuel: 'Petrol', trans: 'Auto', rating: '4.9'),
    _FavCar(name: 'BMW 5 Series', company: 'SafariWheels', price: '\$90/day', seats: 5, fuel: 'Petrol', trans: 'Auto', rating: '4.8'),
    _FavCar(name: 'Toyota Camry', company: 'DriveKigali', price: '\$45/day', seats: 5, fuel: 'Petrol', trans: 'Auto', rating: '4.7'),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: bg,
      drawer: const AppDrawer(activeTab: 2),
      appBar: AppBar(
        backgroundColor: bg,
        elevation: 0,
        ...
        actions: [
          Padding(
            ...
            child: TextButton(
              onPressed: () => setState(() => _favs.clear()),
      ...
      body: _favs.isEmpty
          ? Center(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('Cars you save will appear here', style: TextStyle(color: textSec, fontSize: 12)),
              ]),
            )
          : ListView.separated(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(children: [
                        ...
                        const SizedBox(width: 3),
                        Text(f.fuel, style: TextStyle(fontSize: 11, color: textSec)),
                      ]),
                      const SizedBox(height: 6),
...
class _FavCar {
  final String name, company, price, fuel, trans, rating;
  final int seats;
  const _FavCar({required this.name, required this.company, required this.price, required this.fuel, required this.trans, required this.rating, required this.seats});
}
